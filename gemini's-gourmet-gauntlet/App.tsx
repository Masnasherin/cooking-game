  ...
  const renderContent = () => {
    switch (gameState) {
      ...
      case GameState.ERROR:
        return <p className="text-red-500 text-center font-semibold">{feedbackMessage}</p>;
        ...
        return (
          <>
            <div className="text-center mb-8">
              <p className="text-xl text-orange-800">Your challenge is...</p>
              <h2 className="text-5xl font-bold text-orange-600 font-brand">{recipe.dishName}</h2>
              <p className="mt-2 text-gray-600 max-w-xl mx-auto">Select all the ingredients you think are needed for this recipe from the list below.</p>
            </div>
  ...
  return (
    <div className="min-h-screen bg-amber-50 text-gray-800 flex flex-col items-center justify-center p-4">
      <header className="text-center mb-6">
        <h1 className="text-6xl font-bold text-orange-900 font-brand">Gemini's Gourmet Gauntlet</h1>
      </header>
